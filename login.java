...
public class login {
    ...
    public void loginView() throws SQLException {
		...
		frame.getContentPane().setBackground( Color.decode("#6495ed"));
        ...
        URL gifUrl = getClass().getResource("/images/duck.gif");
        ImageIcon gifIcon = new ImageIcon(gifUrl);

		// Resize the image
        Image resizedImage = gifIcon.getImage().getScaledInstance(150, 150, Image.SCALE_DEFAULT);
	...
	private void openAdminLoginView() {
		...
		adminFrame.getContentPane().setBackground( Color.decode("#6495ed"));
        ...
        login.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(username.isEmpty() || password.isEmpty()) {
					...
					if (id == -1) {
						JOptionPane.showMessageDialog(adminFrame, "User Does Not 	st.", "Warning Message", JOptionPane.WARNING_MESSAGE);
					}
					else if(id == 0) {
